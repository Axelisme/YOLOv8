...
if __name__ == '__main__':
    ...
    parser.add_argument('-t', '--train_name', required=True, type=str, help='Name of the train dataset withou yolo_ prefix')
    parser.add_argument('-v', '--valid_name', required=True, type=str, help='Name of the validation dataset withou yolo_ prefix')
